...
every new user would like to ask the author of django-taggit-autocomplete-modified.
...
**Is this software free?**
    django-taggit-autocomplete-modified is released under the terms of the *Apache License version 2*,
...
**How do I make a donation?**
    ...
    *donate* button. Thank you for considering making a
    donation to django-taggit-autocomplete-modified.
...
**Is django-taggit-autocomplete-modified free-software?**
    django-taggit-autocomplete-modified is released under the terms of the *Apache License version 2*,
...
**Which URL should I use to link to django-taggit-autocomplete-modified?**
    Several places on the web are used to make the django-taggit-autocomplete-modified
    ...
    django-taggit-autocomplete-modified. Thank you and apologies for the inconvenience.
