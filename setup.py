...
from taggit_autocomplete_modified import get_version
...
if __name__=='__main__':
    setup(
        ...
        packages = [
            ...
            #'taggit_autocomplete_modified.templatetags',
            #'taggit_autocomplete_modified.management',
            #'taggit_autocomplete_modified.management.commands',
        ],
